...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> ru = {
    ...
    "create_screen": {
      ...
      "notification_cancelled_error":
          "Возникла ошибка во время отмены напоминания",
      "notification_created": "Напоминание успешно создано",
      "notification_created_error":
          "Возникла ошибка во время создания напоминания"
    },
    "update_screen": {
      "app_bar": "Обновить",
    ...
    "settings_screen": {
      ...
      "notification_change_error":
          "Произошла ошибка при изменении разрешений на уведомления",
      "notification_permitted": "Уведомления разрешены",
      "notification_not_permitted": "Уведомления не разрешены"
    },
    "notifications": {"title": "Задача {taskId} скоро начнётся"},
    "details_screen": {"app_bar": "Детали"}
  };
  static const Map<String, dynamic> en = {
    ...
    "create_screen": {
      ...
      "notification_cancelled_error":
          "An error occurred while cancelling notification",
    ...
    "settings_screen": {
      ...
      "notification_change_error":
          "An error occurred while changing notification permissions",
      "notification_permitted": "Notifications are permitted",
      "notification_not_permitted": "Notifications are not permitted"
    },
    "notifications": {"title": "Task {taskId} is about to start"},
    "details_screen": {"app_bar": "Details"}
  };
